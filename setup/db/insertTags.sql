...
insert into TagMap values ('C9-LAB-DATA','[]LabData/C9','DOUBLE');
...
insert into TagMap values ('CD-BALER-TEMP-LAB-DATA','[]Tags/CD_BALER_TEMP_LAB_DATA','DOUBLE');
insert into TagMap values ('CD-BALER-VOL-LAB-DATA','[]Tags/CD_BALER_VOL_LAB_DATA','DOUBLE');
