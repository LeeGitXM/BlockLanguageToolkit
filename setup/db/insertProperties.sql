...
insert into PropertyMap values ('GDL-MOVING-AVERAGE','sampleSize','SampleSize','INTEGER',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','sampleType','SampleType','STRING',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','updateType','','STRING',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','updateSize','','STRING',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','eraseHistoryWhenReset','SampleType','BOOLEAN',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','requireFullHistory','','BOOLEAN',1,'TAG');
insert into PropertyMap values ('GDL-MOVING-AVERAGE','valueOnInitialization','','STRING',1,'TAG');
