...
insert into PythonPrototypes values ('emc.block.FinalDiagnosis.FinalDiagnosis','SQUARE','','Final Diagnosis','',24,100,80);
insert into PythonPrototypes values ('emc.block.SQCDiagnosis.SQCDiagnosis','SQUARE','','SQC Diagnosis','',24,100,80);
insert into PythonPrototypes values ('emc.block.SubDiagnosis.SubDiagnosis','SQUARE','','Sub Diagnosis','',24,100,80);
