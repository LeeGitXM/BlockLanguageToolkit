...
insert into TagMap values ('SPLIT_RATE_CHANGE-GDA-INPUT','[]Tags/SPLIT_RATE_CHANGE/gdaInput','DOUBLE');
...
insert into TagMap values ('[the bad-value of ALKYL_FLOW]','[]Tags/ALKYL_FLOW/badValue','DOUBLE');
insert into TagMap values ('[the bad-value of C2_FLOW]','[]Tags/C2_FLOW/badValue','DOUBLE');
