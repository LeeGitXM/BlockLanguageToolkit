...
insert into PythonPrototypes values ('xom.block.finaldiagnosis.FinalDiagnosis','SQUARE','','Final\nDiagnosis','',24,100,80);
insert into PythonPrototypes values ('xom.block.sqcdiagnosis.SQCDiagnosis','SQUARE','','SQC\nDiagnosis','',24,100,80);
