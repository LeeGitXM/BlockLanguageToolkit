 ...
 *  
 */
public class ProxyBlock extends AbstractSchematicBlock  {
	 ...
	 */
	public ProxyBlock(String clss,UUID parent,UUID block,ExecutionController cntrlr,ScriptManager mgr) {
