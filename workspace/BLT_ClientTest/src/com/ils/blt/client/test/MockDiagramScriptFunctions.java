...
public class MockDiagramScriptFunctions   {
	...
	public static UUID createMockDiagram(String blockClass,String project) {
		...
		try {
			result = (UUID)GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "createMockDiagram", blockClass,project);
		}
		catch(Exception ge) {
	...
	public static void addMockInput(UUID diagramId,String tagPath,String propertyType,String port ) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "addMockInput", diagramId,tagPath,propertyType, port);
		}
		catch(Exception ge) {
	...
	public static void addMockOutput(UUID diagramId,String tagPath,String propertyType,String port ) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "addMockOutput", diagramId, tagPath, propertyType.toString(),port);
		}
		catch(Exception ge) {
	...
	public static void clearOutput(UUID diagramId,String port) {
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "clearOutput", diagramId, port);
		}
		catch(Exception ge) {
	...
	public static void deleteMockDiagram(UUID diagram) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "deleteMockDiagram", diagram);
		}
		catch(Exception ge) {
	...
	public static void forcePost(UUID diagramId,String port,String value) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "forcePost", diagramId,port,value.toString());
		}
		catch(Exception ge) {
	...
	public static String getState(UUID diagramId) {
		...
		try {
			String result = (String)GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "getState", diagramId);
			state = result;
		}
		catch(Exception ge) {
	...
	public static Object getTestBlockPropertyValue(UUID diagramId,String propertyName){ 
		...
		try {
			result = GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "getTestBlockPropertyValue", diagramId,propertyName);
		}
		catch(Exception ge) {
	...
	public static boolean isLocked(UUID diagramId) {
		...
		try {
			Boolean result = (Boolean)GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "isLocked", diagramId);
	...
	public static QualifiedValue readValue(UUID diagram,String port){ 
		...
		try {
			val = (QualifiedValue) GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "readValue", diagram,port);
	...
	public static void reset(UUID diagramId) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "reset", diagramId);
		}
		catch(Exception ge) {
	...
	public static void setLocked(UUID diagramId,boolean flag) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "setLocked", diagramId,new Boolean(flag));
		}
		catch(Exception ge) {
	...
	public static void setTestBlockProperty(UUID diagramId,String propertyName,Object value){ 
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "setTestBlockProperty", diagramId,propertyName,value.toString());
		}
		catch(Exception ge) {
	...
	public static void setTestBlockPropertyBinding(UUID diagramId,String propertyName,String type,String binding){ 
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "setTestBlockPropertyBinding", diagramId,propertyName,type,binding);
		}
		catch(Exception ge) {
	...
	public static void startMockDiagram(UUID diagram){
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "startMockDiagram", diagram);
		}
		catch(Exception ge) {
	...
	public static void stopMockDiagram(UUID diagram) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "stopMockDiagram", diagram);
		}
		catch(Exception ge) {
	...
	public static void updateBlockAnchor(UUID diagramId,String port,String type) {
		...
		try {
			GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "updateBlockAnchor", diagramId,port,type);
		}
		catch(Exception ge) {
			log.infof("%s.stopMockDiagram: GatewayException (%s)",TAG,ge.getMessage());
		}
	...
	public static long writeCommand(UUID diagram,String command,String arg,String msg) {
		...
		try {
			Long result = (Long)GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "writeCommand", diagram,command,arg,msg);
	...
	public static long writeValue(UUID diagram,String port,int index,String value, String quality) {
		...
		try {
			Long result = (Long)GatewayConnectionManager.getInstance().getGatewayInterface().moduleInvoke(
					BLTProperties.TEST_MODULE_ID, "writeValue", diagram,port,new Integer(index),value,quality);
			if( result!=null ) timestamp = result.longValue();
		}
		catch(Exception ge) {
