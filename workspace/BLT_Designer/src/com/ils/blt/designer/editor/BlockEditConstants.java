...
public interface BlockEditConstants   {
	...
	public static int ENUM_EDIT_PANEL     = 2;
	public static int LIST_EDIT_PANEL     = 3;
	public static int NAME_EDIT_PANEL     = 4;
	public static int TAG_BROWSER_PANEL   = 5;
	public static int VALUE_EDIT_PANEL    = 6;
