...
/**
 * This is an editor for note blocks. We allow the user to enter free-form
 * or HTML text, view the results and re-size the panel.
 */
...
public class NoteTextEditor extends JDialog {
	...
	private static final long serialVersionUID = 2662344376824434427L;
	...
	public NoteTextEditor(ProcessBlockView view) {
		super();
		this.block = view;
