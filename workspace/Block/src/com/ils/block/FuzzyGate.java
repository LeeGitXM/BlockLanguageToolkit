 ...
 */
@ExecutableBlock
public class FuzzyGate extends AbstractProcessBlock implements ProcessBlock {
	 ...
	 */
	public FuzzyGate(ExecutionController ec,UUID parent,UUID block) {
	...
	private void initializePrototype() {
		...
		prototype.setPaletteLabel("FuzzyGate");
