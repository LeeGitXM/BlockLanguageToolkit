...
//	private boolean isTransmitter = false;
	...
	// Do not use a  BlockProperty. Name is a simple class member
	@Override
	public void setName(String txt) { 
		if( txt!=null ) {
			this.name = txt;
			if( controller!=null ) controller.sendNameChangeNotification(getBlockId().toString(),name);
		}
	}
	@Override
...
//	public boolean isTransmitter() { return isTransmitter; }
	...
	public SerializableBlockStateDescriptor toDescriptor() {
		...
		attributes.put(BLTProperties.BLOCK_ATTRIBUTE_PARENT,getParentId().getResourcePath().getFolderPath());
