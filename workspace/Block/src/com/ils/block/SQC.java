...
//		this.setTransmitter(true);
		...
		BlockProperty limitProperty = new BlockProperty(BLOCK_PROPERTY_SQC_LIMIT,limit,PropertyType.DOUBLE,true);
		setProperty(BLOCK_PROPERTY_SQC_LIMIT, limitProperty);
		BlockProperty limitTypeProperty = new BlockProperty(BlockConstants.BLOCK_PROPERTY_LIMIT_TYPE,limitType.name(),PropertyType.LIMIT,true);
		setProperty(BlockConstants.BLOCK_PROPERTY_LIMIT_TYPE, limitTypeProperty);
		BlockProperty maxOutProperty = new BlockProperty(BLOCK_PROPERTY_MINIMUM_OUT_OF_RANGE,minOut,PropertyType.INTEGER,true);
		setProperty(BLOCK_PROPERTY_MINIMUM_OUT_OF_RANGE, maxOutProperty);
		BlockProperty sizeProperty = new BlockProperty(BlockConstants.BLOCK_PROPERTY_SAMPLE_SIZE,DEFAULT_BUFFER_SIZE,PropertyType.INTEGER,true);
