...
public class GatewayRpcDispatcher   {
	 ...
	 */
	public GatewayRpcDispatcher(GatewayContext ctx,ToolkitRequestHandler handler) {
		this.context = ctx;
	...
	public void setTimeFactor(Double factor) {
		...
		requestHandler.setToolkitProperty(BLTProperties.TOOLKIT_PROPERTY_ISOLATION_TIME, String.valueOf(factor));
	}
