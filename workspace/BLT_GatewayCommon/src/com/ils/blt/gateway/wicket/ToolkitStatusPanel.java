...
public class ToolkitStatusPanel extends Panel {
	...
	public ToolkitStatusPanel(String id) {
		...
		IModel<List<BasicDiagram>> diagramListModel = new SimpleDiagramListModel();
		add(new ListView<BasicDiagram>("diagrams",diagramListModel) {
			private static final long serialVersionUID = 3537127058517061095L;
			protected void populateItem(ListItem<BasicDiagram> item) {
				BasicDiagram diagram = item.getModelObject();
