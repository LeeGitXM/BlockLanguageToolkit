...
public class SchematicRequestHandler implements ToolkitRequestHandler  {
	...
	private static SchematicRequestHandler instance = null;
	 ...
	 */
	private SchematicRequestHandler() {
	 ...
	 */
	public static SchematicRequestHandler getInstance() {
		if( instance==null) {
			synchronized(SchematicRequestHandler.class) {
				instance = new SchematicRequestHandler();
			}
		}
		return instance;
	}
