...
public class SchematicDiagramContainer extends BlockDesignableContainer {
	private static final long serialVersionUID = 7484274138362308991L;
	private final UtilityFunctions fncs;

	public SchematicDiagramContainer(AbstractBlockWorkspace workspace,BlockDiagramModel model,EdgeRouter router,ConnectionPainter painter) {
	...
	/**
	 * Paint values available from last execution of the diagram
	 */
	@Override
